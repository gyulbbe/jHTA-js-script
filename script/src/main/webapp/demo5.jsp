...
<script type="text/javascript">
	...
	//		자바스크립트에서는 let키워드를 이용해서 변수를 생성한다.
	...
	// value2 변수는 number타입이다.
	// * 자바스크립트는 정수, 실수 상관없이 전부 number타입이다.
	let value2 = 100;
	...
	// value4 변수는 String타입이다.
	let value4 = "홍길동";

	// value5 변수는 object타입이다.
	// value5 변수는 null값을 가진다.
	// null값을 가지는 변수의 타입의 object 타입이다.
	// null 값을 어떤 객체도 참조하고 있지 않는다는 것을 의마하는 값이다.
	let value5 = null;
	
	// 상수
	// 		상수는 값을 재할당할 수 없기 때문에 상수를 생성할 때
	// 		무조건 할당해야 한다. 값을 할당하지 않으면 오류가 발생한다.
	//		상수명은 변수와 구별하기 위해서 전부 대문자로 적는다.
	const MAX_FILE_LENGTH = 9;
